...
public class WarriorBattle : ModuleRules
{
	public WarriorBattle(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "EnhancedInput", "GameplayAbilities", "UMG", "AIModule", "MotionWarping", "Niagara", "NavigationSystem", "MoviePlayer" });
